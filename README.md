...
`@blockchaincommons/xid` depends on `@blockchaincommons/components`, `@blockchaincommons/dcbor-compat`, `@blockchaincommons/envelope`, `@blockchaincommons/known-values`, `@blockchaincommons/provenance-mark`, `@blockchaincommons/uniform-resources` at runtime.
