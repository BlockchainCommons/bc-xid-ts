...
[@blockchaincommons/xid](https://www.npmjs.com/package/@blockchaincommons/xid) is published to npm. Install it with your package manager of choice:

```sh
npm install @blockchaincommons/xid
# or
pnpm add @blockchaincommons/xid
# or
yarn add @blockchaincommons/xid
# or
...
`bc-xid-ts` is currently under active development and in beta testing. It should not be used for production tasks until it has had further testing and auditing. See [Blockchain Commons' Development Phases](https://github.com/BlockchainCommons/Community/blob/master/release-path.md).
...
`@blockchaincommons/xid` depends on `@blockchaincommons/components`, `@blockchaincommons/dcbor`, `@blockchaincommons/envelope`, `@blockchaincommons/known-values`, `@blockchaincommons/provenance-mark`, `@blockchaincommons/rand`, `@blockchaincommons/tags`, `@blockchaincommons/uniform-resources` at runtime.
...
As an open-source, open-development community, Blockchain Commons does not have the resources to provide direct support of our projects. Please consider the discussions area as a locale where you might get answers to questions. Alternatively, please use this repository's [issues](https://github.com/BlockchainCommons/bc-xid-ts/issues) feature. Unfortunately, we can not make any promises on response time.
