 ...
 *
 *
 * @blockchaincommons/xid - XID Document Library
 *
...
export { XID } from "@blockchaincommons/components";
...
export { Attachments, Edges, type Edgeable } from "@blockchaincommons/envelope";
