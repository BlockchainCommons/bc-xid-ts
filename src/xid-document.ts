...
import { type Cbor, asByteString, toByteString } from "@blockchaincommons/dcbor-compat";
...
export class XIDDocument implements EnvelopeEncodable, Edgeable {
  ...
  toEnvelope(
    ...
    // PrivateKeys implements Signer from @blockchaincommons/components, which is compatible with envelope's sign()
  ...
  static fromEnvelope(
    ...
    switch (verifySignature) {
      ...
      case XIDVerifySignature.Inception: {
        ...
        // Verify signature using the PublicKeys (implements Verifier from @blockchaincommons/components)
